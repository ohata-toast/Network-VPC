...
* 한국(판교), 한국(평촌) 리전에서 프라이빗 IP DNS 기능의 사용 여부를 지정할 수 있습니다. 
  * 프라이빗 IP DNS 기능은 네트워크 인터페이스에 IP 기반으로 할당되는 DNS 호스트 이름을 제공 
...
> [주의 사항] 프라이빗 IP DNS 기능 사용시 과금
> * 프라이빗 IP DNS 기능 사용시 쿼리 사용량에 따라 과금이 됩니다.
> * 쿼리 사용량 무료 구간이 존재합니다.
...
>   * 재시작 없이 네임서버를 변경하려면, 인스턴스에 접속하여 네임서버를 변경해야 합니다.
